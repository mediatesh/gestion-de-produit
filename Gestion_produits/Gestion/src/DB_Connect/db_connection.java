...
public class db_connection {
  ...
  public db_connection(String url, String username, String password, String Host, String Port) {
...
//Fungsi untuk eksekusi query select dengan kolom spesifik
    ...
    public ResultSet querySelectD(String[] nomColonne, String nomTable) {

        connexionDatabase();
        int i;
        SQL = "SELECT SUM(subtotal) as Total, num_facture";

        SQL += " FROM " + nomTable + "group by num_facture";
        return this.exécutionQuery(SQL);
